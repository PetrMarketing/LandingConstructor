...
const pageTemplates = [
    ...
    { id: 'blank', name: 'Пустая страница', category: 'basic', thumbnail: '📄', elements: [] },
    {
        ...
        elements: [
            { type: 'navbar' },
            { type: 'hero', componentSettings: { title: 'Заголовок вашего предложения', subtitle: 'Подзаголовок с описанием ценности для клиента', buttonText: 'Получить консультацию', buttonColor: '#3b82f6' } },
    ...
    // === КОСМЕТОЛОГИЯ ===
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Персональный план развития для косметолога', subtitle: 'Бесплатная консультация от менеджера учебного центра. За 30 минут разберем ваши цели и построим пошаговый план обучения.', buttonText: 'ПОЛУЧИТЬ КОНСУЛЬТАЦИЮ И ПОДАРОК', buttonColor: '#8b5cf6' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    // === ЛИЧНЫЙ БРЕНД ===
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Раскрой свой потенциал с личным коучем', subtitle: 'Бесплатная стратегическая сессия. За 60 минут определим ваши цели и составим план их достижения.', buttonText: 'ЗАПИСАТЬСЯ НА СЕССИЮ', buttonColor: '#8b5cf6' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    // === ИНТЕРНЕТ-МАГАЗИН ===
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Найди свой стиль с персональным стилистом', subtitle: 'Бесплатная консультация по подбору гардероба. Поможем создать образы, которые подчеркнут вашу индивидуальность.', buttonText: 'ПОЛУЧИТЬ КОНСУЛЬТАЦИЮ', buttonColor: '#1e293b' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    // === НЕДВИЖИМОСТЬ ===
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Найдём квартиру вашей мечты за 7 дней', subtitle: 'Бесплатная консультация риелтора. Подберём варианты под ваш бюджет и требования.', buttonText: 'ПОЛУЧИТЬ ПОДБОРКУ КВАРТИР', buttonColor: '#059669' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    },
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Квартиры в ЖК «Парковый» с выгодой до 500 000₽', subtitle: 'Бесплатная консультация менеджера. Подберём планировку под ваш бюджет, рассчитаем ипотеку.', buttonText: 'ПОЛУЧИТЬ РАСЧЁТ', buttonColor: '#1e40af' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    // === РЕСТОРАНЫ И КАФЕ ===
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Забронируйте столик в La Maison', subtitle: 'Французская кухня в сердце города. Бесплатный комплимент от шефа при бронировании онлайн.', buttonText: 'ЗАБРОНИРОВАТЬ СТОЛИК', buttonColor: '#7c2d12' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    },
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Попробуйте specialty кофе бесплатно', subtitle: 'Приходите на дегустацию в Coffee Lab. Расскажем о зёрнах и подберём ваш идеальный напиток.', buttonText: 'ЗАПИСАТЬСЯ НА ДЕГУСТАЦИЮ', buttonColor: '#78350f' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    },
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Пицца за 30 минут или бесплатно!', subtitle: 'Закажите прямо сейчас и получите напиток в подарок к первому заказу.', buttonText: 'ЗАКАЗАТЬ СО СКИДКОЙ 20%', buttonColor: '#dc2626' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    // === ФИТНЕС ===
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Первая тренировка — бесплатно', subtitle: 'Приходите на пробное занятие в FitLife. Познакомим с залом, составим программу под ваши цели.', buttonText: 'ЗАПИСАТЬСЯ БЕСПЛАТНО', buttonColor: '#f97316' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    },
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Достигни формы мечты за 3 месяца', subtitle: 'Бесплатная консультация и диагностика. Разберём твои цели и составим индивидуальный план.', buttonText: 'ЗАПИСАТЬСЯ НА КОНСУЛЬТАЦИЮ', buttonColor: '#16a34a' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    },
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Первое занятие йогой — бесплатно', subtitle: 'Приходите на пробную практику в Shanti Yoga. Подберём направление под ваши цели.', buttonText: 'ЗАПИСАТЬСЯ НА ПРАКТИКУ', buttonColor: '#7c3aed' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    // === ОБРАЗОВАНИЕ ===
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Стань веб-разработчиком за 6 месяцев', subtitle: 'Бесплатная консультация с куратором. Расскажем о программе и составим план обучения.', buttonText: 'ПОЛУЧИТЬ КОНСУЛЬТАЦИЮ', buttonColor: '#2563eb' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    },
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Пробный урок для вашего ребёнка — бесплатно', subtitle: 'Приходите на ознакомительное занятие. Подберём программу по возрасту и интересам.', buttonText: 'ЗАПИСАТЬСЯ НА УРОК', buttonColor: '#ea580c' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    },
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Подготовка к ЕГЭ по математике на 90+ баллов', subtitle: 'Бесплатное пробное занятие. Выявим пробелы и составим индивидуальный план подготовки.', buttonText: 'ЗАПИСАТЬСЯ НА УРОК', buttonColor: '#0891b2' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    // === УСЛУГИ ===
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Запишитесь на процедуру со скидкой 20%', subtitle: 'Первый визит в Beauty Lab — со специальным предложением. Познакомьтесь с нашими мастерами.', buttonText: 'ЗАПИСАТЬСЯ СО СКИДКОЙ', buttonColor: '#db2777' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    },
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Профессиональная уборка от 1500₽', subtitle: 'Рассчитайте стоимость за 30 секунд. Приедем сегодня или в удобное время.', buttonText: 'РАССЧИТАТЬ СТОИМОСТЬ', buttonColor: '#0d9488' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    },
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Бесплатная диагностика автомобиля', subtitle: 'Запишитесь на диагностику — выявим проблемы и рассчитаем стоимость ремонта.', buttonText: 'ЗАПИСАТЬСЯ НА ДИАГНОСТИКУ', buttonColor: '#dc2626' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    // === МЕРОПРИЯТИЯ ===
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'TechConf 2026 — главная IT-конференция года', subtitle: '15-16 марта, Москва. Забронируйте билет со скидкой Early Bird до 1 февраля.', buttonText: 'КУПИТЬ БИЛЕТ СО СКИДКОЙ', buttonColor: '#7c3aed' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    },
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Свадьба вашей мечты — без стресса', subtitle: 'Бесплатная консультация организатора. Обсудим концепцию и бюджет вашего торжества.', buttonText: 'ОБСУДИТЬ СВАДЬБУ', buttonColor: '#be185d' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
    ...
    },
    {
        ...
        elements: [
            ...
            { type: 'hero', componentSettings: { title: 'Организуем праздник, который запомнится', subtitle: 'Бесплатный расчёт стоимости за 5 минут. Детские праздники, корпоративы, юбилеи.', buttonText: 'РАССЧИТАТЬ СТОИМОСТЬ', buttonColor: '#eab308' } },
            { type: 'section', styles: { padding: '80px 20px' }, children: [
